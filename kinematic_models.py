...
class FrontWheelSteeringBicycle(KinematicBicycle):
    ...
    def update_state(self, v, steering_angle, dt):
        ...
        '''
        return super().update_state(v, steering_angle, 0., dt)
...
class CTRVBicycle(FrontWheelSteeringBicycle):
    ...
    def update_state(self, v, steering_angle, dt):
        ...
        if abs(yaw_rate) > 0.01:
            ...
            # slightly inefficient to call the parent method because yaw_rate
            # gets redundantly calculated but this clearly shows the difference
            # between this update and that of the KinematicBicycle
            return super().update_state(v, steering_angle, 0., dt)
